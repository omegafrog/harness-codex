...
The catalog documents only IDs referenced by the active public stage registry or
work-item workflow. It deliberately excludes unreferenced, compatibility, and
retired entries.
