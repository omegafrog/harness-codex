...
[
  ...
  {
    "question": "What interface should the calculator use?",
    "recommended": "Build a simple web page calculator with number buttons, operation buttons, a display area, an equals button, and a clear button.",
    "answer": "단순한 웹 기반 UI"
  },
  {
    "question": "What number input should the calculator support?",
    "recommended": "Support positive and negative decimal numbers, including zero, and calculate one expression at a time with standard operator precedence.",
    "answer": "양수, 음수, 소수까지만"
  }
]
