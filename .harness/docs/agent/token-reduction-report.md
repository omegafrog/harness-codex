...
- maintenance workflow: orchestrator가 bug/maintenance를 분류하고 specialist가 필요한 문서와 targeted verification 범위를 기록한다. 전체 prompt 반복을 피하고 memory/cache/graph triage는 specialist 입력으로 제한한다.
