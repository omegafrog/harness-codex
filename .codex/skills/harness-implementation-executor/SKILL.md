...
description: Execute unchecked tasks for one runtime-dispatched work item.
---

# Implementation Executor Sequence

1. Read current invocation, active plan, execution scope, and only the fixed references needed by the task.
...
7. Write one step-scoped existing result XML with changed files, evidence, remaining tasks, and blockers. Terminate.
