...
`wiki_committer` sub-agent를 spawn한다. 정본 지침은 `.codex/agents/references/wiki_committer.md`다.

sub-agent의 reasoning note와 조율 응답에만 `caveman` 압축을 적용한다. 한국어 commit message와 wiki 산출 문서에는 적용하지 않는다.
