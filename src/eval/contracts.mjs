...
export const HARD_GATE_MODES = Object.freeze({
  ...
  workflow_order_violation: "fail_after_completion",
  forbidden_but_read_only_observation: "fail_after_completion",
  unnecessary_stage_transition: "fail_after_completion",
  reviewer_isolation_violation: "fail_after_completion",
  policy_noncompliance_without_external_side_effect: "fail_after_completion",
  product_source_read_forbidden: "fail_after_completion",
  dependency_unsatisfied_dispatch: "fail_after_completion",
