"""Explicit composition root for runtime extensions.

Package imports expose models and services only. An executable entrypoint calls
``configure_runtime`` once before commands touch state, UI, or agents.
"""
...
def configure_runtime() -> None:
    """Install runtime extensions once, in dependency order."""
...
def _install_runtime_extensions() -> None:
    ...
    # XML is the current canonical durable state authority.
