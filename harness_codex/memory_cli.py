...
def build_parser() -> argparse.ArgumentParser:
    ...
    graph_build = graph_subcommands.add_parser("build", help="Build graph context with local Graphify/Ollama by default.")
    graph_build.add_argument("paths", nargs="*")
    graph_build.add_argument("--backend", choices=("gemini", "kimi", "claude", "openai", "ollama"), default=None)
